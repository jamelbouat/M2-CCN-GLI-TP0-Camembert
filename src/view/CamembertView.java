...
public class CamembertView extends JComponent implements ICamembertView, MouseListener,
	...
	public CamembertView(ModelAdapter modelAdapter) {
		this.addMouseListener(this);
		model = modelAdapter;
		startingAngle = 0.0;
	
        // reminder: we don't want the model to have an observer: use an adapter
	...
	public void mouseClicked(MouseEvent arg0) {
		boolean arcOrButtonClicked = false;
		
		if (center.contains(arg0.getX(), arg0.getY()) || emptyCenter.contains(arg0.getX(), arg0.getY())) {
			controller.deSelect();
